...
sourceFolder = Folder.selectDialog('Select a folder to convert all AI files in it to PDF.'); 
...
if ( sourceFolder != null )
{
	...
	if (files.length > 0) 
	{
		destFolder = Folder.selectDialog( 'Select a folder where to save converted PDF files.' );
